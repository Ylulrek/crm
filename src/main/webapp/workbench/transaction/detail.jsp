...
<%@ page import="com.Ylulrek.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.Ylulrek.crm.workbench.domain.Tran" %>
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		%>
		<%--&lt;%&ndash;<span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom" data-content="资质审查" style="color: #90F790;"></span>
		-----------
		...
		-----------
		<span class="glyphicon glyphicon-record mystage" data-toggle="popover" data-placement="bottom" data-content="因竞争丢失关闭"></span>&ndash;%&gt;
		-------------%>
